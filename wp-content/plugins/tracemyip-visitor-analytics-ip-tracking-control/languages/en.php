<?php
/**
 * Plugin Name: TraceMyIP Plugin
 * Plugin URI: https://www.tracemyip.org
*/
define("UVAR",":-v-:");			// tools URL var separator
if ( ! defined('TMIP_VERSION') ) 	define( 'TMIP_VERSION', '2.34' );
...
define("tmip_support_link", 		'<a href="'.tmip_support_url.'" target="_blank"><b>'.tmip_support_url.'</b></a>');
...
define("tmip_sectl_easy_steps_set", '5 Easy Steps to Setup');
...
// PHRASES
define("tmip_lang_please_rate_us", 	'please rate us');
...
define("tmip_check_trk_code_inst", 	'<b>Please check that the tracker image you have installed shows up on <u>all</u> of your pages</b>.
<br>If you need a hidden version of the tracker, login to your '.tmip_service_Dname.' account and click on the [edit] link located to the right of your project name on "My Projects" page.');

define("tmip_prov_trackerp_valid", 	'The <b>Page Tracker</b> code has been installed');

define("tmip_pagetr_into_vistrak", 	'You have placed a [<b>'.tmip_lang_page_tr_code.'</b>] into the [<b>'.tmip_lang_visitor_tr_code.'</b>] input box. Please place the ['.tmip_lang_page_tr_code.'] into the dedicated input box for ['.tmip_lang_page_tr_code.']');

define("tmip_vistrk_into_pagetrk", 	'You have placed a [<b>'.tmip_lang_visitor_tr_code.'</b>] into the [<b>'.tmip_lang_page_tr_code.'</b>] input box. Please place the ['.tmip_lang_visitor_tr_code.'] into the dedicated input box for ['.tmip_lang_visitor_tr_code.']');
